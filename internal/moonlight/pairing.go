...
type pairingState struct {
	...
	// Phase 2 outputs
	serverSecret    []byte // random 16 bytes — used in hash AND returned in Phase 3 pairingsecret
	serverChallenge []byte // random 16 bytes — appended to Phase 2 encrypted response
	serverResponse  []byte // SHA256(clientChallenge ‖ serverCert.Sig ‖ serverSecret)
